...
```{figure} ./images/fig_v1.png
---
name: v1
---
Representación gráfica de la variable v1 que contiene el valor 5 que es de tipo `int`
```
...
```{figure} ./images/fig_v2.png
---
name: v2
---
Representación gráfica de la variable v2 y de cómo se calcula su valor.
```
...
```{figure} ./images/fig_v3.png
---
name: v3
---
Representación gráfica de la variable v3
```
...
```{figure} ./images/fig_v4.png
---
name: v4
---
Representación gráfica de la variable v4
```
...
En el caso de nuestro ejemplo, se ha incluido un número relativamente grande de comentarios para un programa tan sencillo. Sin embargo, esto sirve para ilustrar un principio importante: ante la duda, es mejor tener más comentarios que menos comentarios en un programa.
 ...
 ```{admonition} Tip
:class: tip
Si tiene dudas sobre si debería incluir un o no, entonces inclúyalo. En la mayoría de los casos siempre será mejor tenar *más* comentarios que *menos* comentarios.
```
...
La operación módulo calcula el **residuo** de la división entera entre dos números. Por ejemplo, el valor de la expresión ```10%3``` es igual a ```1``` porque la división entera entre 10 y 3 tiene como resultado 3 con un residuo de 1 [^modneg].
